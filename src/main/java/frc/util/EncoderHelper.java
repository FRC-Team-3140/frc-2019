...
public class EncoderHelper {
	...
	// Inches is what you desire to convert. Circum is the circumference of the
	// spindle that is moving
	public static double inchesToRevs(double inches, double circum) {
		return inches / circum;
	}

	// Converts inches to # of encoder ticks
	// Inches is what you need to convert. Circum is circumference of spindle.
	// TicksPerRev is native units per
	...
	// EncoderTicks is what you desire to convert. TicksPerRev is native units per
	// revolution of the encoder
