...
public interface Constants {
	...
	public static final int SHIFTER_EXTEND = 1, SHIFTER_RETRACT = 6, ARM_EXTEND = 1, ARM_RETRACT = 6,
			CLIMBER_EXTEND = 1, CLIMBER_RETRACT = 6, FORKLIFT_EXTEND = 1, FORKLIFT_RETRACT = 7;
	public static final int PCM = 1;

	// INTAKE
	public final static int INTAKE_MOTOR = 10, TILT_MOTOR = 9;
