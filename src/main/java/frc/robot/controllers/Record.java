...
import frc.robot.loopController.Loop;
import frc.robot.*;
...
public class Record implements Loop, Constants {
	...
	private void execute() {
		...
		/*if(!reachedFirstNonZero && (Robot.drivetrain.getLeftMasterVoltage() != 0 || Robot.dt.getRightMasterVoltage() != 0 || Robot.el.getElevatorMasterVoltage() != 0 || Robot.in.getLeftIntakeWheelValue() != 0 || Robot.in.getRightIntakeWheelValue() != 0 ||
